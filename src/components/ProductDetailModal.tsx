        ...
        >
            ...
            <div className="flex-1 overflow-y-auto flex flex-col md:flex-row pb-safe">
              ...
              <div className="w-full md:w-2/5 p-5 md:p-8 space-y-6 bg-white">
                  ...
                  <div className="flex gap-3 p-3 bg-blue-50/50 rounded-lg border border-blue-100 text-xs text-blue-800 leading-relaxed">
            ...
            <div className="p-3 bg-white border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-20 shrink-0 pb-safe md:p-5">
