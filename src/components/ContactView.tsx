    ...
    <div ref={containerRef} className="min-h-screen bg-slate-50 pb-20 pt-2 md:pt-4 px-2 md:px-8 font-sans scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="sticky top-[64px] z-30 bg-slate-50/95 backdrop-blur-md pb-2 pt-2 px-1 md:px-0 transition-all border-b border-gray-100/50 md:border-none">
          <div className="flex gap-2 mb-3 items-center"> {/* items-center es clave para alinear */}
            <button 
              onClick={handleCambiarMoto}
              // Altura ajustada (h-12) para coincidir con el nuevo buscador
            ...
            <div className="flex-1 relative z-40"> {/* z-40 para que las sugerencias salgan sobre todo */}
              <SearchBar
                busqueda={busqueda}
              ...
              {visibles.map((product: Producto) => (
                ...
                >
                  ...
                  <div className="p-3 md:p-4 flex flex-col flex-grow relative z-10 bg-white border-t border-gray-50">
                    ...
                    <h3 className="text-xs md:text-sm font-bold text-slate-800 mb-2 leading-snug min-h-[2.5em] group-hover:text-red-600 transition-colors">
          ...
          <div className="flex flex-col items-center justify-center py-24 px-4 text-center">
             ...
             <p className="text-slate-500 max-w-xs mx-auto mb-6">
               {busqueda ? (
                 ...
                 filtroModelo ? `No hay resultados para "${filtroModelo}"` : "Intenta cambiar los filtros."
               )}
             </p>
